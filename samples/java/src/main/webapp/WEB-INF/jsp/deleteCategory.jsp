...
<c:if test="${not empty msg}">
  ...
  <form:form modelAttribute="category" method="post" action="deleteCategory">
	<form:hidden path="id" />
	<div class="form-check">
	  <input class="form-check-input" type="checkbox" value="" id="confirm" required />
      <label class="form-check-label" for="confirm">Check the box to confirm removal of category ${category.name}. I understand this action cannot be undone.</label>
    </div>
