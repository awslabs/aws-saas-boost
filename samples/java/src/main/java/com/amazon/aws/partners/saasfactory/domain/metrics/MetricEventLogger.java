...
public class MetricEventLogger {
    ...
    /*
    To send multiple records to firehose in a batch setup with batchsize > 1
     */
    ...
    /*
    Use this to setup with batch size of 1 when sending 1 record at a time
    */
    ...
    public void log(MetricEvent event) throws JsonProcessingException {
