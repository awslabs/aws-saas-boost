...
function FetchSettings(props) {
    ...
    /**
     * If appConfig object is not empty AND the state value isn't true already.
     * This is to avoid re-rendering the component if the redux state is updated.
     */
    ...
    if (!isEmpty(settings) && !isSettingsLoaded) {
